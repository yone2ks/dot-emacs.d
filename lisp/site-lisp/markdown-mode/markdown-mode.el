...
;; Original ==================
(defvar markdown-header-delimiter-face-1 'markdown-header-delimiter-face-1
  "Face name to use as a base for level-1 header delimiters.")

(defvar markdown-header-delimiter-face-2 'markdown-header-delimiter-face-2
  "Face name to use as a base for level-2 header delimiters.")

(defvar markdown-header-delimiter-face-3 'markdown-header-delimiter-face-3
  "Face name to use as a base for level-3 header delimiters.")

(defvar markdown-header-delimiter-face-4 'markdown-header-delimiter-face-4
  "Face name to use as a base for level-4 header delimiters.")

(defvar markdown-header-delimiter-face-5 'markdown-header-delimiter-face-5
  "Face name to use as a base for level-5 header delimiters.")

(defvar markdown-header-delimiter-face-6 'markdown-header-delimiter-face-6
  "Face name to use as a base for level-6 header delimiters.")
;; End Original ==================
...
(defface markdown-header-delimiter-face-1
  '((t (:inherit font-lock-function-name-face :weight bold)))
  "Base face for level-1 headers hash delimiter."
  :group 'markdown-faces)

(defface markdown-header-delimiter-face-2
  '((t (:inherit font-lock-function-name-face :weight bold)))
  "Base face for level-2 headers hash delimiter."
  :group 'markdown-faces)

(defface markdown-header-delimiter-face-3
  '((t (:inherit font-lock-function-name-face :weight bold)))
  "Base face for level-3 headers hash delimiter."
  :group 'markdown-faces)

(defface markdown-header-delimiter-face-4
  '((t (:inherit font-lock-function-name-face :weight bold)))
  "Base face for level-4 headers hash delimiter."
  :group 'markdown-faces)

(defface markdown-header-delimiter-face-5
  '((t (:inherit font-lock-function-name-face :weight bold)))
  "Base face for level-5 headers hash delimiter."
  :group 'markdown-faces)

(defface markdown-header-delimiter-face-6
  '((t (:inherit font-lock-function-name-face :weight bold)))
  "Base face for level-6 headers hash delimiter."
  :group 'markdown-faces)
;; End Original ====================================
...
(defvar markdown-mode-font-lock-keywords-basic
  (list
   ...
   (cons markdown-regex-header-2-setext '((1 markdown-header-face-2)
                                          (2 markdown-header-rule-face)))
   (cons markdown-regex-header-6-atx '((1 markdown-header-delimiter-face-6)
                                       (2 markdown-header-face-6)
                                       (3 markdown-header-delimiter-face-6)))
   (cons markdown-regex-header-5-atx '((1 markdown-header-delimiter-face-5)
                                       (2 markdown-header-face-5)
                                       (3 markdown-header-delimiter-face-5)))
   (cons markdown-regex-header-4-atx '((1 markdown-header-delimiter-face-4)
                                       (2 markdown-header-face-4)
                                       (3 markdown-header-delimiter-face-4)))
   (cons markdown-regex-header-3-atx '((1 markdown-header-delimiter-face-3)
                                       (2 markdown-header-face-3)
                                       (3 markdown-header-delimiter-face-3)))
   (cons markdown-regex-header-2-atx '((1 markdown-header-delimiter-face-2)
                                       (2 markdown-header-face-2)
                                       (3 markdown-header-delimiter-face-2)))
   (cons markdown-regex-header-1-atx '((1 markdown-header-delimiter-face-1)
                                       (2 markdown-header-face-1)
                                       (3 markdown-header-delimiter-face-1)))
